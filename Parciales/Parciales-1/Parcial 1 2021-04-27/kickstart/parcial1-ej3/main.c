...
/* 
    Como compilar:
    1ero: ejecutamos el siguiente comando: gcc -Wall -Wextra -pedantic -std=c99 -o runner main.c sort.c helpers.c
    borre el -Werror porque no me dejaba compilar por un error de la implementacion de helpers de los profes xd
    , que tenemos que corregir en el ej4.
    2do: Corremos el binario que se nos creo de la siguiente forma: ./runner <path del archivo>
 */